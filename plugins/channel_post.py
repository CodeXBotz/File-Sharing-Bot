...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Tunggu Sayang...!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("Ada suatu kesalahan dikit..!")
        return
    ...
    await reply_text.edit(f"<b>Linknya Disini</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
