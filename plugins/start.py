...
async def not_joined(client: Client, message: Message):
    text = "<b>untuk menggunakan bot anda harus join channel video baru bisa keluar \n\nJoin channel dulu baru bisa buka videonya</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b>and <a href='https://t.me/{client.username}?start={argument}'>👉jika sudah join pencet ini👈</a></b>"
    except ValueError:
        pass
