...
async def not_joined(client: Client, message: Message):
    text = "<b>kamu harus join dulu kechannel dibawah ini agar bot berjalan😊</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b>and <a href='https://t.me/{client.username}?start={argument}'>sudah join? klik disini</a></b>"
    except ValueError:
        pass
